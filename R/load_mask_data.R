...
#' @param cell.data When \code{data.source = "out.tif"}, you **must** provide the cell.data object (prepared with \code{rcell2.cellid::cell.load.alt}).
...
#' 
#' @param images An images dataframe, from  \code{rcell2::load_cell_data} or \code{rcell2.cellid::cell.load.alt}.
