...
This branch attempts to implement the `Hu moments` descriptors in R, and use them on masks generated by CellID (obtained from the `mask_mod` branch, see: https://github.com/darksideoftheshmoo/cellID-linux/tree/mask_mod)
