...
parameters.txt <- rcell2.cellid::parameters.write(rcell2.cellid::parameters.default())
...
```{r}
parameters.list <- rcell2.cellid::parameters.default()
...
```{r}
parameters.txt <- rcell2.cellid::parameters.write(parameters.list)
...
result <- 
  foreach(test.param=test.params, #.export = c(".parameters.df",)
          ...
          .packages = c("rcell2", "base", "dplyr")) %dopar% {
            ...
            # Save parameters
            parameters.txt <- rcell2.cellid::parameters.write(parameters.list.one)
