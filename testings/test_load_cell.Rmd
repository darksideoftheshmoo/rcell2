...
```{r}
path <- "/home/nicomic/Software/cellID-linux/test_data_tmp/"
...
```{r}
cell_data$data %>% ggplot() + geom_point(aes(x=a.tot, y=fft.stat, color = factor(ucid))) + theme(legend.position = "none")
```
