...
```{r}
cell.data <- readRDS(here::here("testings/curvature_tests/cell.data_20201213_60834cca08e2.RDS"))
cell.boundaries <- readRDS(here::here("testings/curvature_tests/cell.boundaries_20201214_6083158baea5.RDS"))
```
