...
#'
#' @param X a cell.data data.frame to which fir.vars are added
#'
#' @return Normalized X
#'
...
#'
#' @param x 
#' @param vars "m" for morph.vars, "f" for fluor.vars
#'
...
#'
#' @param x possibly the cell.data object
#' @param k 
...
#'
#' @return the data with a classification column added as "k.data"
#' @export
#'
